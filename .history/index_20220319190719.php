    ...
    <div class="opinion">
        ...
        <div class="contact-text">
            <form action="" class="form">
                ...
                <p class="opinon-text-title" name="nazwisko">Nazwisko:</p><br>
                <input class="opinion-input" placeholder="Wpisz imię..."></input>
                <p class="opinon-text-title">Opinia:</p><br>
                <input class="opinion-input" placeholder="Wpisz opinie..."></input>
                <button class="send-opinion">Wystaw opinie</button>
            </form>
        </div>
        <div class="comment">
