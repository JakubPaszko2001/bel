...
<main>
    ...
    <div class="realisation-text">
        <h1 class="realisation-h1" id="realizacje">Nasze Realiza</h1>
    </div>
    <div class="gallery">
    ...
    <div class="opinion">
        <form action="connect.php" method="post">
            ...
            <input type="text" class="form" id="firstname" name="firstname" required />
            <label for="firstname">opinia</label>
            <input type="text" class="form" id="opinia" name="opinia" required />
