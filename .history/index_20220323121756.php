...
<main>
    ...
    <div class="main--container">
        ...
        <div class="background__pic">
            ...
            <img class="bck" src="./images/2222.jpg" alt="background">
        </div>
    <!-- TEXT ON IMG -->
    ...
    <div class="opinion">
        ...
        <div class="contact-text">
            <form action="" method="post" class="form">
                ...
                <input class="opinion-input" name="imie" required placeholder="Wpisz imię..."></input>
                <p class="opinon-text-title" >Nazwisko:</p><br>
                <input class="opinion-input" name="nazwisko" required placeholder="Wpisz nazwisko..."></input>
                <p class="opinon-text-title">Opinia:</p><br>
                <input class="opinion-input" name="opinia" required  placeholder="Wpisz opinie..."></input>
