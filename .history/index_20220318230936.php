...
<main>
    ...
    <div class="background">
        <div class="contact-title">
            <h1 class="h1-contanct" id="kontakt">Opinie</h1>
        </div>
        <div class="contact-text">
            <p class="contact-text-title">Imię:</p><br>
            <input class="brown" placeholder="Wpisz imię..."></input>
            <p class="contact-text-title">Nazwisko:</p><br>
            <input class="brown" placeholder="Wpisz imię..."></input>
            <p class="contact-text-title">Opinia:</p><br>
            <input class="brown" placeholder="Wpisz opinie..."></input>
            <button class="send">Wyślij</button>
        </div>
    </div>
</main>
